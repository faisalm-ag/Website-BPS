...
<div class="container">
    <div class="mb-4 text-center">
        <h2 class="fw-bold">People Budaya Organisasi (PeBO)</h2>
        <p class="text-muted">Indikator Perilaku Pegawai BerAKHLAK</p>
    </div>

    <p>Indikator <strong>People Budaya Organisasi (PeBO)</strong> digunakan untuk menilai internalisasi nilai BerAKHLAK dalam perilaku setiap individu ASN di BPS. Penilaian ini mencerminkan kualitas sumber daya manusia sebagai pilar penting budaya kerja.</p>
