...
<div class="container py-5 justify">
    ...
    <div class="mb-4 fade-up nilai">
        <p class="fs-5">
            <strong>Indikator LeadBO</strong> digunakan untuk mengukur sejauh mana pimpinan berperan aktif dalam menginternalisasi nilai-nilai <strong>BerAKHLAK</strong> ke dalam budaya kerja di lingkungan BPS.
        </p>
    </div>
