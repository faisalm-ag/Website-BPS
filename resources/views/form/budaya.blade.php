...
<div class="container">
    <div class="text-center mb-4">
        <h2 class="fw-bold">Form Penilaian Budaya Organisasi</h2>
        <p class="text-muted">BPS Kabupaten Tasikmalaya</p>
    </div>

    <div class="ratio ratio-1x1" style="min-height: 600px;">
        <iframe 
            src="https://docs.google.com/forms/d/e/1FAIpQLSdqsPQtEK7cuFLaKorgw6jtgopWiOPUfaRZW1dB8LPx2dpTqw/viewform?embedded=true" 
            width="100%" 
            height="100%" 
            frameborder="0" 
            marginheight="0" 
